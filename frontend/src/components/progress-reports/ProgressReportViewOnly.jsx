                    ...
                    <div className="mt-3">
                      <div className="relative inline-block">
                        ...
                        <button
                          ...
                          className="absolute -top-2 -right-2 w-6 h-6 min-w-[1.5rem] bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-red-600 transition shadow-md"
