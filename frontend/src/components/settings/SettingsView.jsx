  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <header className="mb-6">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-dark-charcoal">Settings</h1>
      ...
      {activeTab === 'profile' && (
        <div className="max-w-xl">
          <div className="rounded-xl border border-slate-200 bg-white shadow-card-soft overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="flex items-center gap-5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mb-3">{user?.instituteEmail}</p>
                  <input
                    type="file"
                    ref={fileInputRef}
                    accept="image/*"
              ...
              <div className="space-y-3">
                <p className="text-xs font-bold uppercase tracking-widest text-emerald-700 border-b border-emerald-100 pb-1">Account Info</p>
                {[
        ...
        <div className="max-w-xl">
          <div className="rounded-xl border border-slate-200 bg-white shadow-card-soft overflow-hidden">
            ...
            <form className="p-6 space-y-4" onSubmit={handleChangePassword}>
              <p className="text-xs font-bold uppercase tracking-widest text-emerald-700 border-b border-emerald-100 pb-1">Change Password</p>
              {pwError && (
      ...
      {activeTab === 'members' && (
        <div>
          ...
          {!membersLoading && !membersError && (
            <div className="rounded-2xl border border-slate-200 bg-white shadow-card-soft overflow-hidden">
              <div className="bg-gradient-hero px-6 py-4">
                ...
                {members.map((member) => (
                  <div key={member.id} className="flex items-center gap-4 px-6 py-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-500 truncate">{member.instituteEmail || member.username}</p>
                    </div>
